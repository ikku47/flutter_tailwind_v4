...
class TwConfig {
  ...
  static Map<String, Map<String, Map<int, Color>>> colors = {
    ...
    'dark': {
      ...
      'red': {
        50: const Color(0xFF7F1D1D),
        100: const Color(0xFF991B1B),
        200: const Color(0xFFEF4444),
        300: const Color(0xFFFCA5A5),
        400: const Color(0xFFF87171),
        500: const Color(0xFFF87171),
        600: const Color(0xFFDC2626),
        700: const Color(0xFFB91C1C),
        800: const Color(0xFF991B1B),
      ...
      'green': {
        50: const Color(0xFF14532D),
        100: const Color(0xFF166534),
        200: const Color(0xFF15803D),
        300: const Color(0xFF22C55E),
        400: const Color(0xFF34D399),
        500: const Color(0xFF4ADE80),
        600: const Color(0xFF86EFAC),
        700: const Color(0xFFBBF7D0),
        800: const Color(0xFFDCFCE7),
        900: const Color(0xFFF0FDF4),
        950: const Color(0xFFF0FDF4),
      },
      'violet': {
        50: const Color(0xFF2E1065),
        100: const Color(0xFF4C1D95),
        200: const Color(0xFF5B21B6),
        300: const Color(0xFF6D28D9),
        400: const Color(0xFF7C3AED),
        500: const Color(0xFF8B5CF6),
        600: const Color(0xFFA78BFA),
        700: const Color(0xFFC4B5FD),
        800: const Color(0xFFDDD6FE),
        900: const Color(0xFFEDE9FE),
        950: const Color(0xFFF5F3FF),
      },
      'emerald': {
        50: const Color(0xFF064E3B),
        100: const Color(0xFF065F46),
        200: const Color(0xFF047857),
        300: const Color(0xFF059669),
        400: const Color(0xFF10B981),
        500: const Color(0xFF34D399),
        600: const Color(0xFF6EE7B7),
        700: const Color(0xFFA7F3D0),
        800: const Color(0xFFD1FAE5),
        900: const Color(0xFFECFDF5),
        950: const Color(0xFFF0FDF4),
      },
      'amber': {
        50: const Color(0xFF78350F),
        100: const Color(0xFF92400E),
        200: const Color(0xFFB45309),
        300: const Color(0xFFD97706),
        400: const Color(0xFFF59E0B),
        500: const Color(0xFFFBBF24),
        600: const Color(0xFFFCD34D),
        700: const Color(0xFFFDE68A),
        800: const Color(0xFFFEF3C7),
        900: const Color(0xFFFFFBEB),
        950: const Color(0xFFFFFBEB),
      },
      'cyan': {
        50: const Color(0xFF083344),
        100: const Color(0xFF164E63),
        200: const Color(0xFF155E75),
        300: const Color(0xFF0E7490),
        400: const Color(0xFF0891B2),
        500: const Color(0xFF06B6D4),
        600: const Color(0xFF22D3EE),
        700: const Color(0xFF67E8F9),
        800: const Color(0xFFA5F3FC),
        900: const Color(0xFFCFFAFE),
        950: const Color(0xFFECFEFF),
      },
      'pink': {
        50: const Color(0xFF831843),
        100: const Color(0xFF9D174D),
        200: const Color(0xFFBE185D),
        300: const Color(0xFFDB2777),
        400: const Color(0xFFEC4899),
        500: const Color(0xFFF472B6),
        600: const Color(0xFFF9A8D4),
        700: const Color(0xFFFBCFE8),
        800: const Color(0xFFFCE7F3),
        900: const Color(0xFFFDF2F8),
        950: const Color(0xFFFDF2F8),
      },
      'gray': {
